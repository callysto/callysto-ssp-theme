...
?></title>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo SimpleSAML\Module::getModuleURL('callysto/callysto.css'); ?>" />
...
<div id="wrap">
	...
	<div id="header">
		<a href="https://callysto.ca"><img height="15%" width="15%" src="<?php echo SimpleSAML\Module::getModuleURL('callysto/callysto.png'); ?>"/></a>
